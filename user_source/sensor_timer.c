...
// float g_inches_f = 5000;
// float g_inches_r = 5000;
// float g_inches_l = 5000;
...
//     //uart_send_data_blocking(UART_PORT1, "In 0 loop\n\r", sizeof("In 0 loop\n\r"));
//     continue;
//   }
...
//       //uart_send_data_blocking(UART_PORT1, "In 1 loop\n\r", sizeof("In 1 loop\n\r"));
...
//         // Poll PF6
//         // duration = pulse_in(GPIOF, GPIO_PIN_6);
...
//       // sprintf (buffer, "Before a reading\n\r", duration, g_inches_l);
//      // uart_send_data_blocking(UART_PORT1, "Before a reading\n\r", sizeof("Before a reading\n\r"));


//       // duration = pulse_in(GPIOA, GPIO_PIN_13);
//       // distance = duration * 1 / 72000000.0 * 340.0 / 2.0;
//       // g_inches_l = distance * 1000; // distance % 12U;
//             //uart_send_data_blocking(UART_PORT1, "After a reading\n\r", sizeof("After a reading\n\r"));
...
//       // duration = pulse_in(GPIOE, GPIO_PIN_11);
//       // distance = duration * 1 / 72000000.0 * 340.0 / 2.0;
...
//       }
//       // printf("g_inches_f = %f\t", g_inches_f);
...
//       }
//       // printf("g_inches_r = %f\t", g_inches_r);
...
//   // //Interrupt for PA13 : LEFT sensor
//   // HAL_NVIC_SetPriority(EXTI15_10_IRQn, 0, 0);
//   // HAL_NVIC_EnableIRQ(EXTI15_10_IRQn);
// }
